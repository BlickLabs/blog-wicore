...
?>
  ...
  <footer class="site-footer nunitosans-semibold">
    <div>
      <div>
        <a href="index.html">
          <img class="site-footer-logo" src="<? echo get_template_directory_uri() . '/img/logos/wicore-blue-logo.png' ?>">
        </a>
      </div>
        ...
        <div class="site-footer-row">
          <div class="site-footer-column">
            <a href="https://www.linkedin.com/company/wicoremx/" target="_blank">
              <img class="site-footer-icon" src="<? echo get_template_directory_uri() . '/img/icons/in-icon.png' ?>">
            </a>
          </div>
          <div>
            <a href="">
              <img class="site-footer-icon" src="<? echo get_template_directory_uri() . '/img/icons/fb-icon.svg' ?>">
            </a>
          </div>
        </div>
      </div>
